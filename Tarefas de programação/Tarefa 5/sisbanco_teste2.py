from sisbanco_bugs import Banco, ContaEspecial, ContaPoupanca, ContaImposto, Conta
import unittest
...
class TestConta(unittest.TestCase):
    ...
    def test_saldo(self):
        ...
        self.assertTrue(saldo == 0, 'Erro no valor inicial do saldo')
        
    def test_saldo_tipo(self):
        conta = Conta('1234-X')
        saldo = conta.get_saldo()
        self.assertIs(saldo, float, 'Erro no tipo do saldo')
    ...
    def test_debitar(self):
        ...
        #conta.creditar(10)
        conta.debitar(10)
        self.assertEqual(conta.get_saldo(), -10, 'Erro ao debitar')
...
class TestContaEspecial(unittest.TestCase):
    ...
    def test_render_bonus_zera(self):
        conta = ContaEspecial('1234-X')
        conta.creditar(100)
        conta.render_bonus()
        self.assertTrue()
